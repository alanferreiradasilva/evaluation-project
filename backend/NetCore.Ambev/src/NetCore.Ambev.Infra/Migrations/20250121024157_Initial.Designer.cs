...
namespace NetCore.Ambev.Infra.Migrations
{
    ...
    [Migration("20250121024157_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetCore.Ambev.Abstractions.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NetCore.Ambev.Abstractions.Entities.CartProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NetCore.Ambev.Abstractions.Entities.CartProduct", b =>
                {
                    b.HasOne("NetCore.Ambev.Abstractions.Entities.Cart", "Cart")
                        .WithMany("CartProducts")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NetCore.Ambev.Abstractions.Entities.Product", "Product")
                        .WithMany()
